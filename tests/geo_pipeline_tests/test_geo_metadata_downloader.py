...
def test_download_file_success(downloader, mock_output_dir):
    ...
    with patch("requests.get") as mock_get:
        ...
        with patch("builtins.open", mock_open()), patch("tarfile.open") as mock_tar:
            ...
            with patch("os.path.exists", side_effect=lambda path: path.endswith(".tgz")), patch("os.remove") as mock_remove:
