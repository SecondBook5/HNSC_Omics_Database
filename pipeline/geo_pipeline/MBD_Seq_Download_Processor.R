...
for (geo_id in geo_ids) {
  cat("\nInspecting GEO ID:", geo_id, "\n")
  tryCatch({
    mbd_seq_inspection(geo_id)
  }, error = function(e) {
    cat("Error inspecting GEO ID:", geo_id, "\nError message:", e$message, "\n")
  })
}
